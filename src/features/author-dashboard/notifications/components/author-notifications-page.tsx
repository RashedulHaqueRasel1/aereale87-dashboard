...
import type {
  AuthorNotificationRecord,
  AuthorNotificationsData,
} from "../types";

type AuthorNotificationsPageProps = {
  data: AuthorNotificationsData;
};

function NotificationCard({ item }: { item: AuthorNotificationRecord }) {
  return (
...
export function AuthorNotificationsPage({
  data,
}: AuthorNotificationsPageProps) {
  return (
    <div className="space-y-6">
      <PageTitle
        eyebrow="Author Dashboard"
        title="Notifications"
        description="Review your latest support responses, payment updates, and account notices from the Wonder Emporium team."
      />
