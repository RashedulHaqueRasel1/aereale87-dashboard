...
function PasswordField({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex h-12 items-center gap-1 border border-stone-300 bg-stone-100 px-3 py-2.5">
        <div className="flex-1 text-sm text-neutral-500">{placeholder}</div>
            ...
            <div className="flex w-full flex-col gap-3.5">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="relative flex flex-1 flex-col items-start gap-2">
                  ...
                  <div className="text-sm leading-4 text-[#cb9f10]">{profile.roleLabel}</div>
                  <div className="flex items-center gap-4">
                    <div className="text-base leading-5 text-neutral-500">{profile.email}</div>
                    <Pencil className="size-4 text-orange-400" strokeWidth={1.7} />
                  </div>
                  <Badge label={profile.badgeLabel} />
                </div>
              </div>
            </div>
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  <PasswordField
                    ...
                    placeholder={security.currentPasswordHint}
                  />
                  <div className="text-base text-orange-400">
                    {security.forgotPasswordLabel}
                  </div>
                </div>

                <PasswordField label="New Password" placeholder={security.newPasswordHint} />
                <PasswordField
                  label="Re-enter Password"
                  placeholder={security.confirmPasswordHint}
                />
              </div>
            </div>
